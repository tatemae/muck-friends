...
You will need a friend model that 'include MuckFriends::Models::Friend' and a user model that 'include MuckFriends::Models::User'
...
After installing the gem just create a friend model thus:
  ...
  class Friend < ActiveRecord::Base  
    ...
    include MuckActivities::Models::ActivityConsumer  # requires the muck-activities gem
  end
